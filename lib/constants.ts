...
export const SERVICES = [
  {
    ...
    description: "Validate program ROI with statistical rigor. Move from correlation claims to causal proof that builds executive confidence.",
    icon: "BarChart3",
  ...
  },
  {
    ...
    description: "Stop guessing which customers to prioritize. ML models that tell you who will convert and why.",
    icon: "Brain",
  ...
  },
  {
    ...
    description: "From whiteboard to production. Scalable cloud applications that your team can actually use.",
    icon: "Cloud",
  ...
  },
  {
    ...
    description: "End the spreadsheet chaos. Dashboards everyone trusts, automated pipelines, standardized KPIs.",
    icon: "LineChart",
    gradient: "from-teal-500 to-emerald-500",
  },
  {
    id: "data-engineering",
    title: "Data That Flows",
    slug: "data-engineering",
    description: "Reliable pipelines that don't break. Quality data where you need it, when you need it.",
    icon: "Database",
  ...
  },
  {
    ...
    description: "Prepare your people and data for AI adoption. Training, governance, and a clear path forward.",
    icon: "Sparkles",
