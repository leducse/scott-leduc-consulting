...
export const SERVICE_CONTENT = {
  ...
  "genai-governance": {
    title: "GenAI Readiness & Team Enablement",
    overview: "Prepare your organization for AI—not just your data. Combine infrastructure readiness (data governance, contracts, evaluation frameworks) with hands-on team enablement so your people can confidently leverage AI tools and your systems support safe, governed adoption.",
    methodology: [
      "GenAI Readiness Assessment - Evaluate data, dashboards, and team capabilities for AI enablement",
      "Team AI Training - Hands-on workshops covering prompt engineering, tool selection, and use case identification",
      ...
      "AI Adoption Coaching - Ongoing support as teams integrate AI into their workflows",
    ],
    tools: ["Amazon Bedrock", "Amazon OpenSearch", "AWS Lambda", "AWS Step Functions", "Python", "YAML/JSON", "GitHub Actions", "AWS CodeBuild", "ChatGPT/Claude", "AWS Q"],
    deliverables: [
      "GenAI readiness assessment and remediation plan",
      "Team AI training workshops and materials",
      "Prompt engineering playbooks for your use cases",
      "Data contract templates and enforcement frameworks",
...
export const SOLUTION_CARDS = [
  ...
  {
    id: "genai-readiness",
    title: "GenAI Readiness & Enablement",
    problem: "Leadership wants us to 'use AI' but our data is messy and our team doesn't know where to start.",
    solution: "Data audit, governance, and team enablement that makes your organization AI-ready—infrastructure to adoption.",
    proof: "92% documentation coverage, 150+ dashboards audited, hands-on team training",
